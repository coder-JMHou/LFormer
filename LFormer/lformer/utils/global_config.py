...
def parse_args(config_path):
    ...
    parser.add_argument('--config_file', type=str, default=config_path, help='The global config file')
    ...
    parser.add_argument('--dataset_name', type=str, choices=('GF2', 'WV3', 'WV2'),
                        help='The dataset name, support GF2, WV3, WV2')
